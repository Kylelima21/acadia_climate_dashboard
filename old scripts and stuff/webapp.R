...
ui <- fluidPage(
  ...
  tags$body(
    ...
    # div(class = "main-content", #tabindex='0'
      # HTML("<input id='tab1' type='radio' name='tabs' value='1' checked>"),
      # HTML("<label for='tab1'>Dashboard Overview</label>"),
      # HTML("<input id='tab2' type='radio' name='tabs' value='2'>"),
      # HTML("<label for='tab2'>Temperature Trends</label>"),
      # HTML("<input id='tab3' type='radio' name='tabs' value='3'>"),
      # HTML("<label for='tab3'>Precipitation Trends</label>"),
      # HTML("<input id='tab4' type='radio' name='tabs' value='4'>"),
      # HTML("<label for='tab4'>Sea Level Trends</label>"),
      
      # div(class = "tabs-container",
      #     HTML('<ul aria-labelledby="tabs-title">
      #       <li><a id="tab-1" href="#overview"> Dashboard Overview </a></li>
      #       <li><a id="tab-2" href="#temperature"> Temperature Trends </a></li>
      #       <li><a id="tab-3" href="#precipitation"> Precipitation Trends </a></li>
      #       <li><a id="tab-4" href="#sea-level"> Sea Level Trends </a></li>
      #          </ul>'),
      ...
      #              div(class = "tab-content", id = "overview", `aria-labelledby` = "tab-1",
                       # div(class = "summary-box",
                       #   div(class = "sumtxt",
                       #       h2("Summary"),
                       #       p("This dashboard summarizes climate data from Acadia National Park gathered from local weather stations and models, the National Oceanic and Atmospheric Administration (NOAA), and the National Oceanography Centre (NOC). Local data was gathered from the McFarland Hill Atmospheric Research Station, the Winter Harbor-SERC weather station, and the Bar Harbor, Frenchman Bay, ME Station. Climate data was compiled and cleaned to produce visualizations of temperature and precipitation long-term trends, anomalies, and extremes as well as long-term sea level trends. Dashboard design was inspired by the Organisation for Economic Co-operation and Development's Climate Action Dashboard.")
                       #       ),
                       #   tags$img(src = "img/IMG_2172.png",
                       #            alt = "Raindrops and sun through a car windsheild",
                       #            class = "sumimg")
                       #     ),
                       # div(class = "map-box",
      ...
      # 
      # ## ¬ Temperature Trends ----
      #              div(class = "tab-content", id = "temperature", `aria-labelledby` = "tab-2",
      #                  # div(
      #                  #   checkboxGroupInput(
      #                  #     inputId = "linesToShow",
      ...
      #                    value = 20),
      #                  
      #                  print(plotOutput("testplot", width = "850px", height = "400px"))
      #               ),
      # 
      # ## ¬ Precip Trends ----
      #              div(class = "tab-content", id = "precipitation", `aria-labelledby` = "tab-3",
      #                  p("ipsum dolor sit")
      #              ),
      # 
      # ## ¬ Sea Level ----
      # div(class = "tab-content", id = "sea-level", `aria-labelledby` = "tab-4",
      #                  p("ipsum dolor sit")
      #              )
      # ),
      # ),
